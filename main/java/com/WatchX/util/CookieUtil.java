...
/**
 * Utility class for managing cookies in the WatchX application.
 * Provides methods to add, retrieve, and delete cookies for authentication purposes.
 */
public class CookieUtil {
    ...
    public static void addCookie(HttpServletResponse response, String name, String value, int maxAge) {
        ...
        cookie.setPath("/"); // Make cookie available to the entire WatchX application
