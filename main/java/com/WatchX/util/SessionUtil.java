...
/**
* Utility class for managing HTTP sessions in the WatchX application.
...
public class SessionUtil {
   ...
   /**
    * Checks if a user is currently logged in by checking for user attributes in the session.
    *
    * @param request the HttpServletRequest from which the session is obtained
